...
export function FieldEditor({ field, onUpdateField, onSave, onReset, onCancel }: FieldEditorProps) {
  if (!field) {
    return (
      <div className="w-64 border-l bg-gray-50 p-4 flex flex-col h-full">
